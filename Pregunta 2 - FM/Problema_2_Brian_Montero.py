...
class Problema_2_Brian_Montero(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_wavfile_source_0_0_0 = blocks.wavfile_source('D:\\Universidad\\2024-1\\LABCOM\\Certamen2\\Certamen 2 - GNU\\Pregunta 2 - FM\\audioY.mp3', True)
        self.blocks_wavfile_source_0_0 = blocks.wavfile_source('D:\\Universidad\\2024-1\\LABCOM\\Certamen2\\Certamen 2 - GNU\\Pregunta 2 - FM\\audioX.mp3', True)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('D:\\Universidad\\2024-1\\LABCOM\\Certamen2\\Certamen 2 - GNU\\Pregunta 2 - FM\\prueba_audio_1', True)
